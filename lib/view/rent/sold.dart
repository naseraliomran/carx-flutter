...
class rented extends StatelessWidget {
  const rented({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<getallrentedcarcontroller>(
      init: getallrentedcarcontroller(),
      builder: (controller) {
        return RefreshIndicator(
            onRefresh: () => controller.getallrentedcars(),
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return GestureDetector(
                  onTap: () {
                    ...
                    Get.to(() => carrenteddetailsforemplo());
                  },
                  child: Container(
...
class getallrentedcarcontroller extends GetxController {
  @override
  ...
  Future getallrentedcars() async {
    ...
    if (status == 200) {
      if (data.toString() != 'There are no rental cars') {
        car = data;
      }
