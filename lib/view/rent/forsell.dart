...
class forrent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<getallrentcarcontroller>(
      init: getallrentcarcontroller(),
      builder: (controller) {
        return RefreshIndicator(
            onRefresh: () => controller.getallrentcars(),
...
class getallrentcarcontroller extends GetxController {
  @override
