...
class cardetailsforall extends StatefulWidget {
  @override
  State<cardetailsforall> createState() => _cardetailsforallState();
}

class _cardetailsforallState extends State<cardetailsforall> {
  bool isliked = false;
