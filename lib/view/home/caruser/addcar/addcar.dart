...
import 'package:car_x/view/home/caruser/addcar/addcarconn.dart';
import 'package:car_x/view/home/caruser/addcar/addcarcontroller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:lottie/lottie.dart';

class addmycarpage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<addmycarcontrol>(
          init: addmycarcontrol(),
          builder: (controller) {
            return ListView(children: [
              Form(
                  key: controller.keymycar,
                  child: Column(
                      ...
                      children: [
                        ...
                        Container(
                            width: 240,
                            height: 60,
                            child: GetBuilder<addmycarcontrol>(
                                init: addmycarcontrol(),
