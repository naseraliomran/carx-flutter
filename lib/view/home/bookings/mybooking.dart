...
class mybooking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      onRefresh: controller.mybooking,
      child: GetBuilder<booking>(
          didUpdateWidget: (oldWidget, state) => controller.mybooking,
          init: booking(),
          builder: (controller) {
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  controller.data[index]['engineCapacity']
                                      .toString(),
                                  style: TextStyle(
                                      color: Color(0xFF3D3D3D),
                                      fontSize: 20,
                        ...
                        MaterialButton(
                            ...
                            onPressed: () {
                              controller.id =
                                  controller.datac[index]['id'].toString();
                              Get.defaultDialog(
