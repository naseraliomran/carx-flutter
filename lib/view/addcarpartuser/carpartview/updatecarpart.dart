...
import 'package:car_x/view/addcarpartuser/carpartview/updatecarpartconn.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:lottie/lottie.dart';

class updatecarpartuserpage extends StatelessWidget {
  @override
      ...
      body: GetBuilder<addcarpartusercontrol>(
          ...
          builder: (controller) {
            return ListView(children: [
              ...
              Form(
                  key: controller.keycarpartupdateuser,
                  child: Column(
